...
//@FunctionalInventory
public interface ChestImplementedInventory extends Inventory
{
	 /**
     ...
     */
    static ChestImplementedInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
    /**
     * Creates a new inventory with the size.
     */
    static ChestImplementedInventory ofSize(int size) {
